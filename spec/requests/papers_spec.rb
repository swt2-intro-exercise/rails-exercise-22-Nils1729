...
RSpec.describe "/papers", type: :request do
  ...
  let(:valid_attributes) {
    {title: "Solvable and unsolvable problems", venue: "Penguin Books", year: 1954}
  }

  let(:invalid_attributes) {
    {title: "", venue: "Penguin Books", year: 1954}
  }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      let(:new_attributes) {
        {title: "Solvable and unsolvable problems (2)", venue: "Penguin Books", year: 1954}
      }
      ...
      it "updates the requested paper" do
        ...
        paper.reload
        expect(paper.title).to eq "Solvable and unsolvable problems (2)"
      end
